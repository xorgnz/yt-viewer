import { CREATE_TABLE_MIGRATION_HISTORY, MYSQL_CREATE_TABLE_MIGRATION_HISTORY, POSTGRES_CREATE_TABLE_MIGRATION_HISTORY } from '$lib/daos/_schema';
...
export const addMySqlMigrationHistoryMigration: AsyncMigrationDefinition = {
    version: 8,
    name: 'add_migration_history',
    async apply(context) {
        await context.exec(MYSQL_CREATE_TABLE_MIGRATION_HISTORY);
    },
};
